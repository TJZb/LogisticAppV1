...
sqlcmd -S [SERVER] -U [USER] -P [PASSWORD] -i complete_database_setup.sql
```
...
| ตาราง | จุดประสงค์ |
|-------|------------|
| `vehicles` | ข้อมูลรถและยานพาหนะ |
| `fuel_records` | บันทึกการเติมน้ำมัน |
| `employees` | ข้อมูลพนักงาน |
| `users` | ผู้ใช้งานระบบ |
| `fuel_receipt_attachments` | ไฟล์หลักฐานการเติมน้ำมัน |

### ตารางอ้างอิง
| ตาราง | จุดประสงค์ |
|-------|------------|
| `vehicle_brands` | ยี่ห้อรถ |
| `vehicle_categories` | ประเภทรถ |
| `fuel_stations` | สถานีน้ำมัน |
...
-- ตรวจสอบรถ
SELECT license_plate, brand_name, model_name 
FROM vehicles v
